function gridConfig() {
    ...
    let height = 16;
    let width = 16;
    let gridSize = (height * width) * 2;
    
    gridContainer.style.setProperty("--element-height", height);
    gridContainer.style.setProperty("--element-width", width);
    ...
    for (attrib in ["--grid-width", "--grid-height"]) {
    ...
    for (let i = 0; i < width; i++) {
        ...
        for (let j = 1; j <= height; j++) {
            ...
            gridColItem[j].style.height = "30px";
            gridColItem[j].style.width = "30px";
            gridColItem[j].style.border = "1px solid black";
            gridColItem[j].style.display = "inline-block";
            gridColItem[j].style.marginTop = "-6px";
            ...
            gridColItem[j].style.backgroundColor = color;
            gridColItem[j].innerHTML = "";
            gridContainer.appendChild(gridColItem[j]);
            gridColItem[j].addEventListener("mouseover", 
                function () { this.style.backgroundColor = "darkgrey !important"}
            );
        };
    };
}
